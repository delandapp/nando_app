...
import 'package:readism/app/data/models/response_history_peminjaman.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: const Color.fromARGB(255, 210, 210, 210), borderRadius: BorderRadius.circular(10)),
